...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0055B8);
  late Color secondary = const Color(0xFF00C08B);
  late Color tertiary = const Color(0xFF869DB7);
  late Color alternate = const Color(0xFF770E10);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFF869DB7);
  late Color secondaryBackground = const Color(0xFF00C08B);
